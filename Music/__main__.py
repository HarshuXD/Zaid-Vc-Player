...
async def load_start():
    ...
    if restart_data:
        print("[INFO]: SENDING RESTART STATUS TO STARTER SERVER")
        try:
    ...
    await client.send_message(LOG_GROUP_ID, "Assistant Of Starter Music Started")
    print("[INFO]: STARTED THE STARTER BOT AND SENDING THE INFO TO STARTER SERVER")
